...
namespace Auto.Common.Entitis
{
	...
	public partial class Contact : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Nullable<Auto.Common.Entitis.ContactState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.Entitis.ContactState)(System.Enum.ToObject(typeof(Auto.Common.Entitis.ContactState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entitis.Contact> Referencedcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entitis.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_customer_contacts");
				this.SetRelatedEntities<Auto.Common.Entitis.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entitis.Contact> Referencedcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entitis.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced);
			}
			set
			{
				this.OnPropertyChanging("Referencedcontact_master_contact");
				this.SetRelatedEntities<Auto.Common.Entitis.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referenced, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entitis.nav_agreement> nav_contact_nav_agreement_contact
		{
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entitis.nav_agreement>("nav_contact_nav_agreement_contact", null);
			}
			set
			{
		...
		public Auto.Common.Entitis.Contact Referencingcontact_customer_contacts
		{
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entitis.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_customer_contacts");
				this.SetRelatedEntity<Auto.Common.Entitis.Contact>("contact_customer_contacts", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
		...
		public Auto.Common.Entitis.Contact Referencingcontact_master_contact
		{
			get
			{
				return this.GetRelatedEntity<Auto.Common.Entitis.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing);
			}
			set
			{
				this.OnPropertyChanging("Referencingcontact_master_contact");
				this.SetRelatedEntity<Auto.Common.Entitis.Contact>("contact_master_contact", Microsoft.Xrm.Sdk.EntityRole.Referencing, value);
