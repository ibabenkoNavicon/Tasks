...
namespace Auto.Common.Entitis
{
	...
	public partial class nav_credit : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public const string EntityLogicalCollectionName = "nav_credits";
		
		public const string EntitySetName = "nav_credits";
		...
		public System.Nullable<Auto.Common.Entitis.nav_creditState> StateCode
		{
			get
			{
				...
				if ((optionSet != null))
				{
					return ((Auto.Common.Entitis.nav_creditState)(System.Enum.ToObject(typeof(Auto.Common.Entitis.nav_creditState), optionSet.Value)));
				}
				else
				{
					return null;
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entitis.nav_agreement> nav_nav_credit_nav_agreement_creditid
		{
			get
			{
				return this.GetRelatedEntities<Auto.Common.Entitis.nav_agreement>("nav_nav_credit_nav_agreement_creditid", null);
			}
			set
			{
				this.OnPropertyChanging("nav_nav_credit_nav_agreement_creditid");
				this.SetRelatedEntities<Auto.Common.Entitis.nav_agreement>("nav_nav_credit_nav_agreement_creditid", null, value);
		...
		public System.Collections.Generic.IEnumerable<Auto.Common.Entitis.nav_auto> nav_nav_auto_nav_credit
		{
			get
			{
